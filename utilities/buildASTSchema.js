...
var ASTDefinitionBuilder = exports.ASTDefinitionBuilder = function () {
  ...
  ASTDefinitionBuilder.prototype._buildInputType = function _buildInputType(typeNode) {
    return (0, _definition.assertInputType)(this._buildWrappedType(typeNode));
  };

  ASTDefinitionBuilder.prototype._buildOutputType = function _buildOutputType(typeNode) {
    return (0, _definition.assertOutputType)(this._buildWrappedType(typeNode));
  };

  ASTDefinitionBuilder.prototype.buildObjectType = function buildObjectType(ref) {
    var type = this.buildType(ref);
    return (0, _definition.assertObjectType)(type);
  };

  ASTDefinitionBuilder.prototype.buildInterfaceType = function buildInterfaceType(ref) {
    var type = this.buildType(ref);
  ...
  ASTDefinitionBuilder.prototype._makeInputValues = function _makeInputValues(values) {
    ...
    return (0, _keyValMap2.default)(values, function (value) {
      ...
      var type = _this4._buildInputType(value.type);
      return {
        type: type,
  ...
  ASTDefinitionBuilder.prototype._makeUnionDef = function _makeUnionDef(def) {
    ...
    return new _definition.GraphQLUnionType({
      ...
      types: def.types ? def.types.map(function (t) {
        return _this7.buildObjectType(t);
      }) : [],
      astNode: def
    });
  };
